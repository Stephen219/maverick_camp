...
import ac.ke.rondavels.marverick.bookings.ChargeRequest;
...
//import java.util.HashMap;
//import java.util.Map;
//// from  https://attacomsian.com/blog/stripe-integration-with-spring-boot
//
//@Service
...
//            sub.cancel((Map<String, Object>) null);
//            status = true;
//        } catch (Exception ex) {
//            ex.printStackTrace();
//            status = false;
